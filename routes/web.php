...
Route::get('reports/monthly_checks', [MonthlyChecksReportController::class, 'index'])->name('monthlyChecksReport');
Route::get('reports/financial', [FinancialReportController::class, 'index'])->name('financialReport');
